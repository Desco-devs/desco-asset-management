              ...
              <div className="w-full flex flex-row-reverse gap-12">
                ...
                <div className="w-full flex flex-col gap-2 text-sm">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    At DESCO, our people are dedicated and hardworking to
                    satisfy our clients.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    requirements through our partnerships with reputable
                    suppliers of raw materials abroad.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    This has allowed us to shorten acquisition time of crucial
                    raw materials when local suppliers are not available.
                  </p>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    in mechanical, electrical, civil, instrumentation and
                    control works.
                  </p>
                </div>
              </div>
            ...
            <TabsContent value="mission" className="space-y-4 w-full">
              <div className="w-full flex flex-row gap-12">
                ...
                <div className="w-full flex flex-col gap-4 ">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We recognize our people as our most important asset
                    therefore we <strong>Enhance</strong> the competence of our
                    workforce to be among the best in their class and to elevate
                    their quality of life.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    We safeguard all our stakeholders’ welfare as well as that
                    of mother earth. We <strong>Serve</strong> our clients'
                    requirements with utmost consideration for health, safety
                    and the environment.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
