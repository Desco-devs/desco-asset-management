          ...
          {selectedReport.parts_replaced && selectedReport.parts_replaced.length > 0 ? (
            <div className="space-y-4">
              {selectedReport.parts_replaced.map((part, index) => {
                // Debug logging
                console.log('VEHICLE - Part:', part, 'Index:', index);
                console.log('VEHICLE - All attachment_urls:', selectedReport.attachment_urls);
                ...
                console.log('VEHICLE - Part image URL:', partImageUrl, 'Is image:', isImage);
