...
import { useExportMaintenanceReports } from "@/hooks/useVehiclesQuery";
import type { ExportFilters } from "@/stores/vehiclesStore";

interface ExportDialogProps {
  isOpen: boolean;
  onClose: () => void;
  vehicles?: Array<{ id: string; brand: string; model: string; plate_number: string }>;
}

export function ExportDialog({ isOpen, onClose, vehicles = [] }: ExportDialogProps) {
  ...
  const handleExport = () => {
    const exportFilters: ExportFilters = {
      ...
      vehicleId: filters.vehicleId === 'ALL_VEHICLES' ? undefined : filters.vehicleId,
      ...
      <DialogContent className="sm:max-w-[525px]">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={filters.vehicleId || 'ALL_VEHICLES'}
