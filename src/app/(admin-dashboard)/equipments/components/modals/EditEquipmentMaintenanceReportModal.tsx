  ...
  useEffect(() => {
    if (selectedReport) {
      setFormData({
        ...
        parts_replaced: selectedReport.parts_replaced?.length > 0 ? selectedReport.parts_replaced : [""],
        attachment_urls: selectedReport.attachment_urls?.length > 0 ? selectedReport.attachment_urls : [""],
      });
    }
  }, [selectedReport]);
  ...
  return (
    <Dialog open={!!selectedReport} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Equipment Maintenance Report</DialogTitle>
        </DialogHeader>
